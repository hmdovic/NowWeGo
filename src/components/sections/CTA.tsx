...
export default function CTA() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden border-t border-paper/10 py-32 md:py-48"
    >
      ...
      <div className="container-edge relative text-center">
        <Reveal>
          <span className="mb-8 flex items-center justify-center gap-3 text-xs font-medium uppercase tracking-[0.25em] text-paper/40">
          ...
          <p className="mx-auto mt-8 max-w-lg text-base leading-relaxed text-paper/50">
